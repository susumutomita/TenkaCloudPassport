# ADR-0012: 重複ラチェットで止め、デッドコードは報告する
...
コピー&ペーストを止められないため、area (src 配下の directory 単位)の重複行数を
...
- 関連 ADR: [ADR-0003](./0003-quality-first-no-mvp.md)、[ADR-0009](./0009-schema-versioning-and-strict-boundaries.md)
